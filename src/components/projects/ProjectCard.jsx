...
export function ProjectCard({ title, description, tags, link, github, image, index }) {
  ...
  const ImagePlaceholder = () => (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-800 gap-3">
    ...
    <>
      ...
      >
        ...
        <div className="p-6 flex flex-col grow relative z-20">
          ...
          <p className="text-gray-400 text-sm mb-6 grow leading-relaxed">{description}</p>
          ...
          <div className="flex gap-3 mt-auto">
            ...
            <button
              ...
              className="flex items-center justify-center w-auto h-12 rounded-xl bg-slate-800 border p-2.5 border-white/10 text-gray-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-300"
              title="View Details"
            >
