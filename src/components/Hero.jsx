  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex absolute left-6 md:left-10 flex-col gap-6 text-gray-400 z-50 hero-socials">
        <Magnetic>
          <a target="_blank" href="https://www.linkedin.com/in/md-jakerul-islam/" className="p-2 block" rel="noopener noreferrer">
            <FaLinkedin className="hover:text-blue-500 cursor-pointer text-2xl transition-colors" />
          </a>
        </Magnetic>
        <Magnetic>
          <a target="_blank" href="https://github.com/jakerul-islam" className="p-2 block" rel="noopener noreferrer">
            <FaGithub className="hover:text-white cursor-pointer text-2xl transition-colors" />
          </a>
        </Magnetic>
        <Magnetic>
          <a target="_blank" href="https://x.com/jakerulislam0" className="p-2 block" rel="noopener noreferrer">
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="hero-btn pt-8 relative z-20">
            <Magnetic>
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=jakerulislam024@gmail.com"
                target="_blank"
